"""
Django settings for literarymm project.
...
SECRET_KEY = 'django-insecure-v5u22)k#&+*z0j*l0dz6#h=s+-9t42pc8ac@d*s(2xe-dmcc^&'
...
WSGI_APPLICATION = 'literarymm.wsgi.application'
